...
export type CalendarProps = ComponentProps<typeof CalendarRac> & BaseCalendarProps;
export type RangeCalendarProps = ComponentProps<typeof RangeCalendarRac> & BaseCalendarProps;
...
const Calendar = ({ className, ...props }: CalendarProps) => {
  return (
    <CalendarRac
      {...props}
      className={composeRenderProps(className, (value) => cn("w-fit", value))}
    >
      <CalendarHeader />
